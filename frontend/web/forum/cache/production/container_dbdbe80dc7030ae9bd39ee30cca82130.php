...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gothick.recaptcha2.captcha.recaptcha2' => 'getGothick_Recaptcha2_Captcha_Recaptcha2Service',
    ...
    protected function getCaptcha_Plugins_ServiceCollectionService()
    {
        ...
        $instance->add('gothick.recaptcha2.captcha.recaptcha2');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('shredder.sitemap.listener', 'shredder\\sitemap\\event\\listener');
    ...
    /**
     * Gets the public 'gothick.recaptcha2.captcha.recaptcha2' shared service.
     *
     * @return \gothick\recaptcha2\captcha\recaptcha2
     */
    protected function getGothick_Recaptcha2_Captcha_Recaptcha2Service()
    {
        $this->services['gothick.recaptcha2.captcha.recaptcha2'] = $instance = new \gothick\recaptcha2\captcha\recaptcha2($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('language'), $this->get('request'), $this->get('template'), $this->get('log'), './../', 'php');

        $instance->set_name('gothick.recaptcha2.captcha.recaptcha2');
    ...
    /**
     * Gets the public 'shredder.sitemap.appender' shared service.
     *
     * @return \shredder\sitemap\appender
     */
    protected function getShredder_Sitemap_AppenderService()
    {
        return $this->services['shredder.sitemap.appender'] = new \shredder\sitemap\appender($this->get('config'), $this->get('user'), './../', 'php');
    }

    /**
     * Gets the public 'shredder.sitemap.controller' shared service.
     *
     * @return \shredder\sitemap\controller\sitemap
     */
    protected function getShredder_Sitemap_ControllerService()
    {
        return $this->services['shredder.sitemap.controller'] = new \shredder\sitemap\controller\sitemap($this->get('shredder.sitemap.appender'), $this->get('shredder.sitemap.core'), $this->get('cache'), $this->get('config'), $this->get('user'));
    }

    /**
     * Gets the public 'shredder.sitemap.core' shared service.
     *
     * @return \shredder\sitemap\core
     */
    protected function getShredder_Sitemap_CoreService()
    {
        return $this->services['shredder.sitemap.core'] = new \shredder\sitemap\core($this->get('shredder.sitemap.appender'), $this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('dbal.conn'), $this, $this->get('ext.manager'), $this->get('user'), './../', 'php');
    }

    /**
     * Gets the public 'shredder.sitemap.listener' shared service.
     *
     * @return \shredder\sitemap\event\listener
     */
    protected function getShredder_Sitemap_ListenerService()
    {
        return $this->services['shredder.sitemap.listener'] = new \shredder\sitemap\event\listener($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('template'), $this->get('user'), './../', 'php');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000447cdfc000000000521752f4(
    ...
    {
        return $this->services['vse.abbc3.acp_manager'] = new \vse\abbc3\core\acp_manager($this->get('dbal.conn'), $this->get('group_helper'), $this->get('language'), $this->get('request'));
    }

    /**
     * Gets the public 'vse.abbc3.bbcodes_config' shared service.
     *
    ...
    /**
     * Gets the public 'vse.abbc3.bbcodes_help' shared service.
     *
     * @return \vse\abbc3\core\bbcodes_help
     */
    protected function getVse_Abbc3_BbcodesHelpService()
    {
        return $this->services['vse.abbc3.bbcodes_help'] = new \vse\abbc3\core\bbcodes_help($this->get('vse.abbc3.bbcodes_display'), $this->get('dbal.conn'), $this->get('language'), $this->get('template'), $this->get('user'));
    }
    ...
    {
        return $this->services['vse.abbc3.listener'] = new \vse\abbc3\event\listener($this->get('vse.abbc3.bbcodes_config'), $this->get('vse.abbc3.bbcodes_display'), $this->get('vse.abbc3.bbcodes_help'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), 'ext/vse/abbc3/');
    }
    ...
    {
        return $this->services['vse.abbc3.wizard'] = new \vse\abbc3\controller\wizard($this->get('cache.driver'), $this->get('controller.helper'), $this->get('request'), $this->get('template'), $this->get('text_formatter.s9e.factory'));
    }
...
class phpbbtemplatetwiglexer_00000000447cdfc000000000521752f4 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c2081ef8cd5c518539737 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c2081ef8cd68892514320 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c2081ef8cd3d478867539 = array(
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, 'set_environment', array('env' => $env), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;

        return $this->valueHolder5c2081ef8cd5c518539737->set_environment($env);
    }
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;

        return $this->valueHolder5c2081ef8cd5c518539737->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;

        return $this->valueHolder5c2081ef8cd5c518539737->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c2081ef8cd68892514320 = $initializer;
    }
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, '__get', array('name' => $name), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;

        if (isset(self::$publicProperties5c2081ef8cd3d478867539[$name])) {
            return $this->valueHolder5c2081ef8cd5c518539737->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c2081ef8cd5c518539737;
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, '__isset', array('name' => $name), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, '__unset', array('name' => $name), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;
    ...
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, '__clone', array(), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;

        $this->valueHolder5c2081ef8cd5c518539737 = clone $this->valueHolder5c2081ef8cd5c518539737;
    }

    public function __sleep()
    {
        $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, '__sleep', array(), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;

        return array('valueHolder5c2081ef8cd5c518539737');
    }
    ...
    {
        return $this->initializer5c2081ef8cd68892514320;
    }
    ...
    {
        return $this->initializer5c2081ef8cd68892514320 && ($this->initializer5c2081ef8cd68892514320->__invoke($valueHolder5c2081ef8cd5c518539737, $this, 'initializeProxy', array(), $this->initializer5c2081ef8cd68892514320) || 1) && $this->valueHolder5c2081ef8cd5c518539737 = $valueHolder5c2081ef8cd5c518539737;
    }
    ...
    {
        return null !== $this->valueHolder5c2081ef8cd5c518539737;
    }
    ...
    {
        return $this->valueHolder5c2081ef8cd5c518539737;
    }
